    ...
    <el-container direction="vertical" style="margin:220px 40px 24px 40px;">
      ...
      <div class="breadcrumb">
        <el-breadcrumb separator-class="el-icon-arrow-right">
          ...
          <el-breadcrumb-item>技术成果</el-breadcrumb-item>
          <el-breadcrumb-item>{{ this.$route.query.cgmc }}成果详情</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
        <div class="form_info">
            <!-- 技术基础信息 -->
            <div>
                <div class="tech_basic">
                    <img :src="cgtp" style="width: 400px;">
                    <div class="tech_basic_info">
                        <h1>{{ this.$route.query.cgmc }}</h1>
                        <div class="tech_basic_info_body">
                            <div>权属人：{{ this.$route.query.cgqsr }}</div>
                            <div>交易价格：{{ this.$route.query.hzjg }}</div>
                            <div>进行时间：2020.04.12~2020.06.10</div>
                            <div>技术完成时间：{{ this.$route.query.cgwcsj }}</div>
                            <div>地址：{{ this.$route.query.dwdz }}</div>
                        </div>
                    </div>
                </div>
                <!--公司信息 --> 
                ...
                <div class="Ach_info">
                    <!--成果基本情况-->
                    <div class="Ach_info_body">
                        <h1>成果基本情况</h1>
                        <div class="Ach_info_body_info">
                            <div>成果获得方式：{{ this.$route.query.cghqfs }}</div>
                            <div>关键词：{{ this.$route.query.gjc }}</div>
                            <div>合作方式：{{ this.$route.query.hzfs }}</div>
                            <div>行业领域：{{ this.$route.query.lyName }}</div>
                            <div>技术成熟度：{{ this.$route.query.jscsd }}</div>
                        </div>
                    </div>
                    <!--成果简介-->
                    <div class="Ach_info_introduction">
                        <h1>成果简介</h1>
                        <div class="Ach_info_introduction_info">
                            <p>
<!--                                随着科学技术的不断发展，有些农作物是一年一熟，现在都能做到一年两熟，甚至是一年三熟，现在很多农户为
                              ...
                              {{ this.$route.query.cgjs }}
                            </p>
                        </div>
                    </div>
                    <!--技术指标-->
                    <div class="Ach_info_technical">
                        <h1>技术指标</h1>
                        <div class="Ach_info_technical_info">
                            <p style="font-size: 16px;text-align: left;line-height: 32px;">
            ...
            <div class="newest">
                ...
                <div class="newest_body" v-for="(iteam, index) in allprojects" :key="index">
                    <div class="newest_info">
                        <img :src="iteam.cgtp" width="200px">
                        <div class="newest_info_body">
                            <div style="font-weight:bold; margin-bottom: 20px;">{{ iteam.cgmc }}</div>
...
<script>
    ...
    export default {
      ...
      methods:{
        ...
        showImg(){
          this.cgtp =this.$route.query.cgtp;
        }
      }
