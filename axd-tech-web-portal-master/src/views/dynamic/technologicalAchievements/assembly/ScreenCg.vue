		...
		<div class="search_bg">
			<div class="search">
				<div class="search_operction">
					<el-select class="CgType" v-model="value1" placeholder="技术类型">
					...
					<el-select class="CgField" v-model="value2" placeholder="技术领域">
				...
				<el-col  :xs="6" :sm="6" :md="6" :lg="6" :xl="6" v-for="(item, index) in allprojects" :key="index">
					<div class="Ach_project">
						...
						<div class="Ach_project_body">
							...
							<div class="Ach_project_body_field">应用成果领域：
							...
							<div class="Ach_project_body_introduce">成果介绍：
								<span style="color: #000;">{{ item.introduction }}</span>
							</div>
