<template>
    <el-dialog :close-on-click-modal="false" :title="formData.cgmc + '的审核意见' " top="30vh" :visible.sync="dialogVisible4.show"
    width="40%" center @close="closeClear()">
        <div style="padding: 20px;">
            <div style="display: flex; justify-content: flex-start; align-items: center;flex-wrap: nowrap;margin-bottom: 24px;">
                ...
                <p style="font-size: 16px; color: #000;" label="审核意见">{{formData.slxbbz}}</p>
            </div>
