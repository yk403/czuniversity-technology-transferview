<template>
  <!--编辑需求信息-->
  <el-dialog :close-on-click-modal="false" :title="formData.xqmc" top="0vh" :visible.sync="dialogVisible1.show"
    width="75%" center @close="closeClear()">
            <el-form :model="formData" :rules="formRules" ref="ruleForm" label-width="100px" label-position='right'>
                ...
                <!--需求领域-->
                    <div class="Req_choice_info_body_field">
                        <span class="fields_text" style="text-align: left; width:100px;">
                ...
                <!--需求类别-->
                    <div class="Req_choice_info_body">
                        <div class="fields_text" style="text-align: left; width:100px;">
...
<style scoped>
    ...
    .company_info_body , .Req_basic_info_body , .Req_choice_info_body{
      padding: 20px 0 0 20px;
      display: flex;
      flex-wrap: wrap;
      flex-direction: row;
