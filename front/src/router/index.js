	...
	},
	{
		...
		children: [
			{	//审核管理
				...
				component: resolve => require(['@/views/dynamic/sys/ApprovalManagement/index.vue'], resolve)
			},
            {	//信息采集
				path:'/InformationAcquisition',
				name: 'InformationAcquisition',
				component: resolve => require(['@/views/dynamic/sys/InformationAcquisition/index.vue'], resolve)
			},
            // 技术招标
			{	//信息采集
				path:'/Acquisition', 
				name: 'AcquisitionZB',
				component: resolve => require(['@/views/dynamic/cloud/Bidding/Acquisition/acquisition.vue'], resolve)
			},
            {   //审批管理
				path:'/Approval', 
				name: 'ApprovalZB',
				component: resolve => require(['@/views/dynamic/cloud/Bidding/Approval/index.vue'], resolve)
            },
            {   //活动管理
				path:'/Activity', 
				name: 'ActivityZB',
				component: resolve => require(['@/views/dynamic/cloud/Bidding/Activity/activity.vue'], resolve)
            },
            {   //归档清算管理
				path:'/FileGd', 
				name: 'FileGdZB',
				component: resolve => require(['@/views/dynamic/cloud/Bidding/fileGd.vue'], resolve)
            },
            {   //活动会场管理
				path:'/Venue', 
				name: 'VenueZB',
				component: resolve => require(['@/views/dynamic/cloud/Bidding/venue.vue'], resolve)
            },
            // 技术拍卖
			{	//信息采集
				path:'/AcquisitionPM', 
				name: 'AcquisitionPm',
				component: resolve => require(['@/views/dynamic/cloud/Auction/acquisition.vue'], resolve)
			},
            {   //审批管理
				path:'/ApprovalPM', 
				name: 'ApprovalPm',
				component: resolve => require(['@/views/dynamic/cloud/Auction/approval.vue'], resolve)
            },
            {   //活动管理
				path:'/ActivityPM', 
				name: 'ActivityPm',
				component: resolve => require(['@/views/dynamic/cloud/Auction/activity.vue'], resolve)
            },
            {   //归档清算管理
				path:'/FileGdPM', 
				name: 'FileGdPm',
				component: resolve => require(['@/views/dynamic/cloud/Auction/fileGd.vue'], resolve)
            },
            {   //活动会场管理
				path:'/VenuePM', 
				name: 'VenuePm',
				component: resolve => require(['@/views/dynamic/cloud/Auction/venue.vue'], resolve)
            },
            //技术挂牌
			{	//信息采集
				path:'/AcquisitionGP', 
				name: 'Acquisition',
				component: resolve => require(['@/views/dynamic/cloud/Listing/acquisition.vue'], resolve)
			},
            {   //审批管理
				path:'/ApprovalGP', 
				name: 'Approval',
				component: resolve => require(['@/views/dynamic/cloud/Listing/approval.vue'], resolve)
            },
            {   //活动管理
				path:'/ActivityGP', 
				name: 'Activity',
				component: resolve => require(['@/views/dynamic/cloud/Listing/activity.vue'], resolve)
            },
            {   //归档清算管理
				path:'/FileGdGP', 
				name: 'FileGd',
				component: resolve => require(['@/views/dynamic/cloud/Listing/fileGd.vue'], resolve)
            },
            {   //活动会场管理
				path:'/VenueGP', 
				name: 'Venue',
				component: resolve => require(['@/views/dynamic/cloud/Listing/venue.vue'], resolve)
            },
			{	//双创路演
				path:'/TraningCenter',
				name: 'TraningCenter', 
				component: resolve => require(['@/views/dynamic/training/TraningCenter.vue'], resolve)
			},
			{
