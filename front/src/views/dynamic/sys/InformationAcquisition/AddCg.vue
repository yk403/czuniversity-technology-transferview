            ...
            <el-form :model="formData" :rules="formRules" ref="ruleForm" label-width="100px" label-position='right'>
                ...
                <div class="Req_basic_info">
                    ...
                    <div class="Req_basic_info_body">
                        <el-form-item label="成果权属人:" prop="cgqsr">
                            <el-input v-model="formData.cgqsr"></el-input>
                        </el-form-item>
                        <el-form-item label="权属人电话:" prop="qsrlxdh">
                ...
                <!--需求领域-->
                    <div class="Req_choice_info_body">
                        <div class="fields_text" style="text-align: left; width:120px;">
                            <span style="color: red;">*</span>技术领域
                        </div>
                        <div class="checkbox">
                ...
                <!--需求类别-->
                    <div class="Req_choice_info_body">
                        <div class="fields_text" style="text-align: left; width:120px;">
                            <span style="color: red;">*</span>技术类别
                        </div>
                        <div class="checkbox">
            ...
            <div class="Req_img">
                ...
                <div class="Req_img_body">
                  ...
                  <div class="Req_img_upload">
                    ...
                    <el-form-item label="照片路径" prop="carImg" hidden>
