    ...
    <!--新增、搜索栏-->
        <div class="Bid_acp_info">
            <div class="Bid_acp_info_button">
                <el-button type="warning" @click="addCg">+ 新增</el-button>
            </div>
    ...
    methods:{
		...
		handlgetById(index, row) {
			...
			this.form = {
				...
				this.$refs.AddCg.checklist[0]= Number(this.form.lyId)
				this.$refs.AddCg.checklist2[0]= Number(this.form.lbId)
				this.$refs.AddCg.checklist3[0]= this.form.hzfs
				this.$refs.AddCg.initImage(this.form.cgtp)
