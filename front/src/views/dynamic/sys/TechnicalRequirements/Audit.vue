    ...
    <!-- 审核弹出框 -->
          <el-dialog title="审核" :visible.sync="AuditShow.show" width="500px">
            ...
            <el-form-item label="备注">
                <el-input type="textarea" :rows="4" v-model="formData.fbwtgsm"></el-input>
            </el-form-item>
        ...
        <div slot="footer" class="dialog-footer">
            ...
            <el-button type="primary" @click="audit(4)">拒 绝</el-button>
        </div>
    </el-dialog>
</template>
...
export default {
    ...
    methods:{
        ...
        audit(data){
            ...
            api.auditXq(this.form2).then(res =>{
                console.log(this.form2,111);
