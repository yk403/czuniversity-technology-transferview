	...
	>
		...
		>
			...
			<div class="Req_choice_info">
				...
				<div class="Req_choice_info_body">
					<div
						...
						style="text-align: left; width:120px;"
					>
						<span style="color: red;">*</span>成果类别
					</div>
					<div class="checkbox">
						<el-checkbox
							style="margin: 10px;"
			...
			<div class="Req_img" style="border-bottom:1px solid #e7e7ee">
				...
				<div class="Req_img_body">
					<div class="Req_fields_text">
						<span style="color: red;">*</span>上传的图片：
					</div>
            ...
            <div class="Red_button">
                    <el-button @click="fbshzt(2)">通过</el-button>
                    <el-button @click="fbshzt(3)">整改</el-button>
                    <el-button @click="fbshzt(4)">拒绝</el-button>
            </div>
            <!-- 整改意见 -->
		...
		<div class="Req_operation_edit">
			<el-button class="Req_operation_edit_cancel">取消</el-button>
			<el-button
...
export default {
	...
	methods: {
		...
		makeSure() {
            const that = this
            api.auditCg(this.formData).then(res =>{
...
.company_info_body,
.Req_basic_info_body,.Red_information_body {
