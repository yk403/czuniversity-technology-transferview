		...
		<div class="label_body_head">
			<div style="display:flex;">
                ...
                <div class="label_body_search">
                    <el-button style="margin-left:20px;" type="warning" @click="add()"
                        >创建活动</el-button
                    >
		...
		<div style="margin:0 20px;">
			...
			>
				...
				<el-table-column
					...
					label="活动内容"
				>
                    <el-button type="text">活动内容</el-button>
                </el-table-column>
				<el-table-column
					prop="contracts"
					label="活动规则"
				...
				<el-table-column
					...
					label="需求列表"
				>
                    <el-button type="text">需求列表</el-button>
                </el-table-column>
                <el-table-column
					prop="agreement"
					label="报名人数"
				>
                    <el-button type="text">报名人数</el-button>
                </el-table-column>
				<el-table-column
					v-if="show1"
					prop="fbwtgsm"
				...
				<el-table-column label="操作" width="200">
                        <el-button type="text">会场管理</el-button>
